...
if ($has_orders) : ?>
    ...
    <h2><?php echo apply_filters(
            ...
            __('Recent Orders', 'woocommerce-gateway-placetopay')
        ); ?></h2>
    ...
    <table class="shop_table shop_table_responsive my_account_orders  woocommerce-MyAccount-orders shop_table shop_table_responsive my_account_orders account-orders-table">
        ...
        <thead>
            <tr>
                ...
                <th class="order-status"><span class="nobr"><?php _e('Authorization/CUS', 'woocommerce-gateway-placetopay'); ?></span></th>
                    ...
                    <tr class="order">
                        ...
                        <?php if ($metaStatus == 'APPROVED_PARTIAL' && $order->get_status() == 'pending') { ?>
                            ...
                            <td class="order-total" data-title="<?php _e('Total', 'woocommerce-gateway-placetopay'); ?>">
                                <?php echo $order->get_currency() . ' ' . sprintf(
                                    _n(
                                        '%s (%s) for %s item',
                                        '%s (%s) for %s items',
                                        $item_count,
                                    ...
                                    wc_price(get_post_meta($order->get_id(), '_order_total_partial', true)),
    ...
    <?php if (1 < $customer_orders->max_num_pages) : ?>
        <div class="woocommerce-Pagination">
            <?php if (1 !== $current_page) : ?>
                <a class="woocommerce-Button woocommerce-Button--previous button" href="<?php echo esc_url(wc_get_endpoint_url('orders', $current_page - 1)); ?>"><?php _e(
                                                                                                                                                                        'Previous',
                                                                                                                                                                        'woocommerce-gateway-placetopay'
                                                                                                                                                                    ); ?></a>
            <?php endif; ?>
            ...
            <?php if (intval($customer_orders->max_num_pages) !== $current_page) : ?>
                <a class="woocommerce-Button woocommerce-Button--next button" href="<?php echo esc_url(wc_get_endpoint_url('orders', $current_page + 1)); ?>"><?php _e(
                                                                                                                                                                    'Next',
                                                                                                                                                                    'woocommerce-gateway-placetopay'
                                                                                                                                                                ); ?></a>
            <?php endif; ?>
...
<?php else : ?>
    <div class="woocommerce-Message woocommerce-Message--info woocommerce-info">
        <a class="woocommerce-Button button" href="<?php echo esc_url(apply_filters(
